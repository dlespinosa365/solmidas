...
return [
    ...
    'attributes' => [
        ...
        'withPlatibanda' => 'Com platibanda',
        'distanceBetweenFrames' => 'Distância entre quadros',
        'distanceBetweenColumns' => 'Distância entre colunas',
        'shipLength' => 'Comprimento do Navio',
        'columnHeight' => 'Altura das colunas',
        'floor' => 'Piso',
        'shoes' => 'Zapata',
        'metalClosure' => 'Metal Closure',
        'anticorrosiveTreatment' => 'Tratamento anticorrosivo',
        'facadeDensity' => 'Espessura da fachada',
        'coverDensity' => 'Espessura da capa',
        'emergencyDoors' => 'Portas de Emergência',
        'emergencyDoorsCount' => 'Número de portas de emergência',
        'emergencyDoorsHeight' => 'Altura das portas de emergência',
        'emergencyDoorswidth' =>'Largura das portas de emergência',
        'serviceDoors' => 'Portas de serviço',
        'serviceDoorsCount' => 'Número de portas de serviço',
        'serviceDoorsHeight' => 'Altura das portas de serviço',
        'serviceDoorswidth' => 'Largura das portas de serviço',
        'sectionedDoorsLessThan16' => 'Portas seccionadas com menos de 16 m',
        'sectionedDoorsLessThan16Count' => 'Número de portas seccionadas com menos de 16 m',
        'sectionedDoorsLessThan16Height' => 'Altura de portas seccionadas menor que 16 m',
        'sectionedDoorsLessThan16width' => 'Largura das portas seccionadas menor que 16 m',
        'sectionedDoorsMajorThan16' => 'Portas seccionadas maiores que 16 m',
        'sectionedDoorsMajorThan16Count' => 'Número de portas seccionadas maior que 16 m',
        'sectionedDoorsMajorThan16Height' => 'Altura de portas seccionadas maior que 16 m',
        'sectionedDoorsMajorThan16width' => 'Largura das portas seccionadas maior que 16 m',
        'requireMontage' => 'Requer montagem',
    ]
];
